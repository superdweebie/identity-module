 ...
 */
class ForgotCredentialToken extends \Sds\IdentityModule\DataModel\ForgotCredentialToken implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'code', 'identityName', 'expires');
    }
